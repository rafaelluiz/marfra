...
class OrcamentoCalculistaController extends Controller
{
    private $orcamento;
    ...
    public function __construct(Orcamento $orcamento)
    {
        ...
        view()->share('menu', 'calculista/orcamentos');
    }
    ...
    public function index()
    {
        ...
        $orcamentos = $this->orcamento->listarCalculista();
...
//        dd($request->all());
        ...
        if ($validator->fails()) {
            return redirect('calculista/orcamento/editar/'.$id)->withErrors($validator)->withInput();
        }
        ...
        if ($retorno) {
            ...
            switch ($envio) {
                case 'salvarEFechar' : $redirect = 'calculista/orcamentos'; $tratamento = 'alterado'; break;
                case 'salvar' : $redirect = 'calculista/orcamento/editar/'.$id; $tratamento = 'alterado'; break;
                case 'salvarELiberar' : $redirect = 'calculista/orcamentos'; $tratamento = 'salvo e liberado'; break;
            }
