...
class CreateSubprodutoConjuntoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('subproduto_conjunto', function (Blueprint $table) {
            $table->increments('id')->unique()->comment('Código identificador único da tabela');
            $table->string('nome', 40)->unique()->comment('Nome do conjunto do subproduto');
    ...
    {
        Schema::drop('subproduto_conjunto');
    }
}
