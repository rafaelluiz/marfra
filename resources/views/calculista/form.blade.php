...
<form action="{{ route('calculista/orcamento/update') }}" method="post">
...
<div class="row">
        ...
        <div class="ibox float-e-margins">
          <div class="ibox-title">
            <h5>Técnico orçamentista<span class="sub_description"> - dados técnicos</span></h5>
                                              ...
                                              <div class="panel-body">
                                                <div class="col-lg-12">
                                                  <div class="form-group col-lg-3 padding-0">
                                                    ...
                                                    <div class="checkbox i-checks col-sm-6">
                                                      <label class="primeiro_produto">
                                                        <div class="icheckbox_square-blueMarfra checked">
                                                          <input type="checkbox" value="" checked="">
                                                        </div>
                                                        <i></i> Mecanizado
                                                      </label>
                                                    ...
                                                    <div class="checkbox i-checks col-sm-6">
                                                      <label>
                                                        <div class="icheckbox_square-blueMarfra">
                                                          <input type="checkbox" value="">
                                                        </div>
                                                        <i></i> Automatizado
                                                      </label>
...
<div class="ibox-content">
                ...
                <div class="col-md-3 form-group padding-0">
                  <span class="clique_aqui m download_label">Esboço.pdf</span>
                  <div class="hr-line-dashed clear_both"></div>
                  <span class="clique_aqui m upload_label">Projeto_Orçamentario.pdf</span>
                  <div class="hr-line-dashed clear_both"></div>
                </div>
                <div class="col-md-1 form-group">
                </div>
                
              <div class="hr-line-dashed clear_both visibility_none"></div></div>
            </div>
      </div>
                    <!--final dados tecnicos-->
                    <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Orçamento<span class="sub_description"> - discrimine o orçamento</span></h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
                  ...
                  <table class="table invoice-total">
                    ...
                    <div class="hr-line-dashed clear_both visibility_none"></div>
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                  <a href="{{ route('calculista/orcamentos') }}" class="btn btn-white btn_cancel"><i class="fa fa-times"></i>&nbsp;&nbsp;Cancelar</a>
