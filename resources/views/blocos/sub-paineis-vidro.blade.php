<!-- Inicio Subitem Fechamento de Vão - Painéis de Vidro -->
<div class="panel-group" id="{{ $configuracao['id'] }}">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#{{ $configuracao['id'] }}" href="#collapse{{ $configuracao['id'] }}">Painéis de Vidro</a>
...
<!-- Fim Subitem Fechamento de Vão - Painéis de Vidro -->