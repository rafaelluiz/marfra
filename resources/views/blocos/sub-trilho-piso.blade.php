<!-- Inicio Subitem Portão de Garagem - Trilho no piso -->
<div class="panel-group" id="{{ $configuracao['id'] }}">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#{{ $configuracao['id'] }}" href="#collapse{{ $configuracao['id'] }}">Trilho no piso</a>
...
<!-- Fim Subitem Portão de Garagem - Trilho no piso -->