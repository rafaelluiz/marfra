<!-- INICIO PAINEL FECHAMENTO DE VÃO -->
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="collapsed" data-id="{{ $configuracao['id'] }}" data-toggle="collapse" data-parent="#accordion{{ $configuracao['id'] }}" href="#collapse{{ $configuracao['id'] }}" onclick="(new Utilidade).toggleButton(this);">
                        Fechamento de Vão&nbsp;&nbsp;<i class="fa fa-chevron-down" data-id="{{ $configuracao['id'] }}"></i><i class="fa fa-chevron-up" data-id="{{ $configuracao['id'] }}" style="display: none;"></i>
                    </a>
            ...
            <div id="collapse{{ $configuracao['id'] }}" class="panel-collapse collapse">
                <div class="panel-body">
                    <!-- Inicio Opções Fechamento de Vão -->
                    ...
                    <!-- Inicio Bloco Subitens Fechamento de Vão -->
                    <div class="col-lg-12">
                        <div class="ibox-content" id="bloco-subproduto-{{ $configuracao['id'] }}">

                        </div>
                    </div>
                    <!-- Fim Bloco Subitens Fechamento de Vão -->
                </div>
            </div>
        </div>
    </div>
</div>
<!-- FIM PAINEL FECHAMENTO DE VÃO -->