<!-- Inicio Subitem Fechamento de Vão - Porta de garagem -->
<div class="panel-group" id="{{ $configuracao['id'] }}">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#{{ $configuracao['id'] }}" href="#collapse{{ $configuracao['id'] }}">Portão de garagem</a>
...
<!-- Fim Subitem Fechamento de Vão - Porta de garagem -->